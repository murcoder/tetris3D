        ...
        blocks_0.push(block4_0);
    	 ...
    	 var topleft = [row/2-1, col-col+2, (row/2)-1]; //[x=middle-1, y=top-1, z=depthMiddle-1]; Also saved in spawn()!
      	 ...
      	 var objectLength = 4; //Default in rotation 0
    		...
    		tetrominos.push( tetrominoConstructor("T", items,posSize,colSize, colors, vertexIndices, blocks_0, objectGrid0, objectGrid90, objectGrid180, objectGrid270,  topleft, blocksFromMiddle));
